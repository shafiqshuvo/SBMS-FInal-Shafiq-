...
CREATE DATABASE Project1DBFinal;
USE Project1DBFinal;
...
INSERT INTO Supplier(Code, Name, Address, Email, Contact,ContactPerson) VALUES ('1003', 'Nasrin TElecom', 'Dhanmondi', 'nasrimabcd@gmail.com', '01527478885','015275785216');
...
CREATE TABLE Sales(
	...
	CONSTRAINT FK_ProductS FOREIGN KEY(Product) REFERENCES (Code)
)

SET DATEFORMAT 'dmy';

INSERT INTO Sales(Date, Customer, Category, Product, Quantity, MRP) VALUES ('03-OCT-1999', '1000', '1001','1005', '20', '200');
